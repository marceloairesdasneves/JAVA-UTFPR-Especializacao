...
public class Teste {
    ...
    private static final Leitura l = new Leitura(); // Assumindo que 'Leitura' é uma classe utilitária
    private static Veiculo passeio;
    ...
    public static void main(String[] args) {
        ...
        do{
            ...
            try{
                // Leitura da opção pega o Integer.parseInt() para converter a string lida para int.
            ...
            try {
                switch (opcao) {
                    case 1:
                        ...
                        if (vagaPasseio == -1) {
                            l.entDados("\nCheca se o VETOR de PASSEIO esta cheio. press <Enter>");
                            break;
                        }
